...
class MobileNetFC:
    ...
    def load_pretrained_imagenet(self):
        ...
        self.load_base_weights('docrec/models/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_1.0_224_no_top.h5')
...
if __name__ == '__main__':
    ...
    model.load_base_weights('docrec/models/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_1.0_96_no_top.h5')
