PROJECT=deeprec-sib18
BASE_DIR=/mnt/data
PROJECT_DIR=$BASE_DIR/deeprec-sib18
...
echo -e "${ORANGE}4) Customizing Keras MobileNET${NC}"
cp docrec/models/mobilenet_v2.py $ENV_DIR/lib/python3.$PYTHON_VERSION/site-packages/keras_applications